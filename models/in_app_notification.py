...
class InAppNotification(db.Model):
    ...
    user_type = db.Column(db.String(20), nullable=False)  # student, tutor, admin, guardian

    type = db.Column(db.String(50), nullable=False)  # booking, payment, review, system, etc.
    ...
    source_id = db.Column(db.String(100), nullable=True)  # used for grouping
